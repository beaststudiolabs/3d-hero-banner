...
- Render a banner with valid GLB/GLTF model URLs and verify render_success appears in diagnostics.
- Intentionally break a model URL and verify fallback + error diagnostics fire.
