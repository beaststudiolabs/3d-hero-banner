# Release Checklist (v0.2.4)

## Goal
Ship `Beastside 3D Hero Banner v0.2.4` as a reproducible WordPress plugin release with traceable artifacts.
...
- [x] `beastside-3d-hero-banner/beastside-3d-hero-banner.php` header `Version` is `0.2.4`.
- [x] `beastside-3d-hero-banner/beastside-3d-hero-banner.php` constant `BS3D_VERSION` is `0.2.4`.
...
## 8. GitHub Release
- [ ] Tag release commit (example: `v0.2.4`).
- [ ] Push tag to GitHub.
